...
public class AudioPlayer {
    ...
    private void udpStream() {
        try (MulticastSocket udpSocket = new MulticastSocket(this.port)) {
            ...
            udpSocket.joinGroup(new InetSocketAddress(multicastGroup, this.port), NetworkInterface.getByInetAddress(InetAddress.getByName("127.0.0.1")));
